 ...
 */
public class MyBookStoreConnection extends javax.swing.JFrame {

    /**
     * Creates new form Read
     */
    public MyBookStoreConnection() {
        initComponents();
    ...
    private void showdata() {
        ...
        String sql = inputquery.getText();
        if (sql.equalsIgnoreCase("select * from books;")) {
        ...
        } else if (sql.equalsIgnoreCase("select * from authors;")) {
        ...
        } else if (sql.equalsIgnoreCase("select * from books_authors;")) {
            model.addColumn("authorID");
            model.addColumn("isbn");
            try {
                java.sql.Statement stm = conn.createStatement();
...
//            conn.commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyBookStoreConnection.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MyBookStoreConnection().setVisible(true);
            }
        });
    }
