 ...
 */
public class MyGUIdbUpdate extends javax.swing.JFrame {

    /**
     * Creates new form Read
     */
    public MyGUIdbUpdate() {
        initComponents() ;
        uneditable() ;
        view();
...
//        jTextField1.setEditable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyGUIdbUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MyGUIdbUpdate().setVisible(true);
            }
        });
    }
