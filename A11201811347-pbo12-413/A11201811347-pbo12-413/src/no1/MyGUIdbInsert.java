 ...
 */
public class MyGUIdbInsert extends javax.swing.JFrame {

    /**
     * Creates new form Read
     */
    public MyGUIdbInsert() {
        initComponents() ;
        view();
...
//        jTextField1.setEditable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyGUIdbInsert.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MyGUIdbInsert().setVisible(true);
            }
        });
    }
